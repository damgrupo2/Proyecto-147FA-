 ...
 * @author 7fbd06
 */
public class VehiculoFormularioEdit extends javax.swing.JFrame {

    private Vehiculo v;
    /**
     * Creates new form TrabajadorFormulario
     */
    public VehiculoFormularioEdit(int id) {
        initComponents();
        v = Vehiculo.verVehiculo(id);
        jtMatricula.setText(v.getMatricula());
    ...
    private void initComponents() {
        ...
        jltitulo.setText("Modificar vehiculo");
        ...
        jtModelo.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(jtModelo, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 486, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        int idVehiculo = VehiculoListado.getId();
        String matricula = jtMatricula.getText();
        String modelo = jtModelo.getText();
        String marca = jtMarca.getText();
        
        Modelo.Vehiculo v = new Vehiculo(idVehiculo,matricula,modelo,marca);
        boolean correcto = v.modificarVehiculo();
        if(correcto){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VehiculoFormularioEdit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        //</editor-fold>
        //</editor-fold>
        int id = VehiculoListado.getId();
        /* Create and display the form */
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                
                new VehiculoFormularioEdit(id).setVisible(true);
            }
        });
    }
