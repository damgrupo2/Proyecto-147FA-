 ...
 * @author 7fbd06
 */
public class VehiculoFormulario extends javax.swing.JFrame {

    private List<Centro> centros;
    /**
     * Creates new form TrabajadorFormulario
     */
    public VehiculoFormulario() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Modelo.Vehiculo v = new Vehiculo(matricula,modelo,marca);
        boolean correcto = v.guardarVehiculo();
        if(correcto){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VehiculoFormulario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VehiculoFormulario().setVisible(true);
            }
        });
    }
