...
INSERT INTO PARTE VALUES('25/04/17',1,1,5,NULL,NULL,NULL,NULL,NULL,0,NULL,0,1);
INSERT INTO REPARTO VALUES('25/04/17',1,13456,'25/04/17 20:20:00','25/04/17 20:26:00');
COMMIT;
DELETE FROM REPARTO;
DESCRIBE PARTE;
...
SELECT SUM(EXTRACT(HOUR FROM(HORA_FIN - HORA_INICIO)) + MINUTOS_A_HORAS(EXTRACT(MINUTE FROM(HORA_FIN-HORA_INICIO)))) AS TOTAL FROM REPARTO WHERE FECHA='25/04/17';

CREATE OR REPLACE FUNCTION MINUTOS_A_HORAS(HORA IN PARTE.EXCESO_HORAS%TYPE )
